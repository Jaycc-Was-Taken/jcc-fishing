...
RegisterNetEvent('jcc-fishing:freshwatershop')
AddEventHandler('jcc-fishing:freshwatershop', function ()
...
RegisterNetEvent('jcc-fishing:salthwatershop')
AddEventHandler('jcc-fishing:saltwatershop', function ()
	TriggerServerEvent("inventory:server:OpenInventory", "shop", "saltwaterfish", Config.SaltwaterItems)
end)
RegisterNetEvent('jcc-fishing:client:sellfish')
AddEventHandler('jcc-fishing:client:sellfish', function(data)
...
RegisterNetEvent('jcc-fishing:client:startFishing')
AddEventHandler('jcc-fishing:client:startFishing', function()
    local ped = PlayerPedId()
